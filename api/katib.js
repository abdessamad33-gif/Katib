export default async function handler(req, res) {
  ...
  try {
    ...
    const instructions = {
      ...
      style: 'حسن أسلوب النص العربي واجعله أكثر سلاسة واحترافية. أعد النص المحسن فقط.',
      simplify: 'بسط النص العربي واجعله واضحًا وسهل الفهم. أعد النص المبسط فقط.',
      formal: 'حول النص العربي إلى أسلوب رسمي ومهذب. أعد النص الرسمي فقط.',
      social: 'حول النص العربي إلى منشور مناسب لوسائل التواصل الاجتماعي. أعد المنشور فقط.'
    };
